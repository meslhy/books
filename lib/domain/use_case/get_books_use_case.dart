...
@injectable
class GetBooksUseCase extends Cubit{
  HomeRepo repo;
  GetBooksUseCase(this.repo):super(BaseRequestInitialState());

  void execute()async{
    Either<Failuer,AllBooksResponses> either = await repo.getAllBooks(false);
